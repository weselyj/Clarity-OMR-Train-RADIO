# Outer launcher: detaches the inner Stage 1 RADIO training wrapper from SSH via WMI.
$ErrorActionPreference = "Stop"
$repo = Join-Path $env:USERPROFILE "Clarity-OMR-Train-RADIO"
$inner = Join-Path $repo "scripts\full_radio_stage1_inner.ps1"
...
$pidFile = Join-Path $repo "logs\full_radio_stage1.pid"
...
$logFile = Join-Path $repo "logs\full_radio_stage1.log"
$errFile = Join-Path $repo "logs\full_radio_stage1.err"
