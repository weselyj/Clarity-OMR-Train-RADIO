# Launch Phase 4.2 compile A/B inner script via WMI Create.
$ErrorActionPreference = "Stop"
$repo  = Join-Path $env:USERPROFILE "Clarity-OMR-Train-RADIO"
$inner = Join-Path $repo "scripts\cu132_phase4_compile_inner.ps1"
...
Write-Host "LOG=$repo\logs\cu132_phase4_compile.log"
Write-Host "PROFILE=$repo\bench\cu132_compile\profile.jsonl"
