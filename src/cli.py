...
# Decoder-runtime helpers moved to src.inference.decoder_runtime so they survive
# archival of the per-staff CLI. Re-exported here for any in-tree caller that
# still imports them from src.cli (the CLI itself uses them in run_stage_b).
